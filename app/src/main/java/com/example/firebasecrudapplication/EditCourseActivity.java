...
public class EditCourseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        courseSuitedForEdt= findViewById(R.id.idEdtSuitedFor);
        courseImgEdt=findViewById(R.id.idEdtImageLink);
        courseLinkEdt=findViewById(R.id.idEdtCourseLink);
        courseDesEdt=findViewById(R.id.idEdtCourseDescription);
        ...
        if(courseRVModal!=null){
            ...
            courseDesEdt.setText(courseRVModal.getCourseDes());
        ...
        updateCourseBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String courseDes= courseDesEdt.getText().toString();
